...
* @{
*/
#define PRODUCT_KEY "dd49742996974404840a315dd2a2ecf3"
/**@} */
/**@name Product Secret (产品密钥)
* @{
*/
#define PRODUCT_SECRET "4a7189d737f64b469863aa790f746f44"
/**@} */
...
* @{
*/
#define SWITCH_DOOR_BYTEOFFSET                    0
#define SWITCH_DOOR_BITOFFSET                     0
#define SWITCH_DOOR_LEN                           1

#define LATCH_LOCK_BYTEOFFSET                    0
#define LATCH_LOCK_BITOFFSET                     1
#define LATCH_LOCK_LEN                           1

#define RANDOM_PASSWD_BYTEOFFSET                    0
#define RANDOM_PASSWD_BITOFFSET                     2
#define RANDOM_PASSWD_LEN                           1

#define CHILDREN_MODE_BYTEOFFSET                    0
#define CHILDREN_MODE_BITOFFSET                     3
#define CHILDREN_MODE_LEN                           1

#define FLAG_SWITCH_BYTEOFFSET                    4
#define FLAG_SWITCH_BITOFFSET                     0
#define FLAG_SWITCH_LEN                           1


#define SWITCH_MODE_RATIO                         1
#define SWITCH_MODE_ADDITION                      1
#define SWITCH_MODE_MIN                           0
#define SWITCH_MODE_MAX                           9

#define VISITOR_PASSWD_RATIO                         1
#define VISITOR_PASSWD_ADDITION                      0
#define VISITOR_PASSWD_MIN                           0
#define VISITOR_PASSWD_MAX                           65535

#define SWITCH_TIME_RATIO                         1
#define SWITCH_TIME_ADDITION                      0
#define SWITCH_TIME_MIN                           0
#define SWITCH_TIME_MAX                           255

#define DUMP_ENERGY_RATIO                         1
#define DUMP_ENERGY_ADDITION                      0
#define DUMP_ENERGY_MIN                           0
#define DUMP_ENERGY_MAX                           100

#define SWITCH_MANID_RATIO                         1
#define SWITCH_MANID_ADDITION                      0
#define SWITCH_MANID_MIN                           0
#define SWITCH_MANID_MAX                           500
...
/** 用户区设备状态结构体*/
typedef_t struct {
  bool valueswitch_door;
  bool valuelatch_lock;
  bool valuerandom_passwd;
  bool valuechildren_mode;
  uint32_t valueswitch_mode;
  uint32_t valuevisitor_passwd;
  bool valueFlag_switch;
  uint32_t valueswitch_time;
  uint32_t valuedump_energy;
  uint32_t valueswitch_manID;
} dataPoint_t;

/** 对应协议“4.10 WiFi模组控制设备”中的标志位"attr_flags" */ 
typedef_t struct {
  uint8_t flagswitch_door:1;
  uint8_t flaglatch_lock:1;
  uint8_t flagrandom_passwd:1;
  uint8_t flagchildren_mode:1;
  uint8_t flagswitch_mode:1;
  uint8_t flagvisitor_passwd:1;
} attrFlags_t;

/** 对应协议“4.10 WiFi模组控制设备”中的数据值"attr_vals" */
typedef_t struct {
  uint8_t wBitBuf[COUNT_W_BIT];
  uint8_t valueswitch_mode;
  uint16_t valuevisitor_passwd;
} attrVals_t;
...
typedef_t struct {
  ...
  uint8_t valueswitch_time;
  uint8_t valuedump_energy;
  uint16_t valueswitch_manID;
