...
void LED_Open(uint8_t num, uint8_t status)
{
	if(status)
  {
    switch (num)
    {
      ...
      case 1: GPIO_SetBits(GPIOB, GPIO_Pin_4);break;//置1
      case 2: GPIO_SetBits(GPIOB, GPIO_Pin_5);break;//置1
    }
  }
	...
	else
  {
    switch (num)
    {
      ...
      case 1: GPIO_ResetBits(GPIOB, GPIO_Pin_4);break;//置0
      case 2: GPIO_ResetBits(GPIOB, GPIO_Pin_5);break;//置0
    }
  }
