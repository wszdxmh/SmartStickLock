...
* @{
*/
#define PRODUCT_KEY "5ab47bfcfbca47ecbdcada7deaf6e7f9"
/**@} */

/**@name 数据点相关定义
* @{
*/
#define SWITCH_ONOFF_BYTEOFFSET                    0
#define SWITCH_ONOFF_BITOFFSET                     0
#define SWITCH_ONOFF_LEN                           1

#define AIRLIGHT_BYTEOFFSET                    0
#define AIRLIGHT_BITOFFSET                     1
#define AIRLIGHT_LEN                           1


#define TEMP_RATIO                         1
#define TEMP_ADDITION                      16
#define TEMP_MIN                           0
#define TEMP_MAX                           14

#define OFF_TIME_RATIO                         0.5
#define OFF_TIME_ADDITION                      0
#define OFF_TIME_MIN                           0
#define OFF_TIME_MAX                           48
...
__packed typedef struct {
  uint8_t flagswitch_onoff:1;
  uint8_t flagairlight:1;
  uint8_t flagtemp:1;
  uint8_t flagoff_time:1;
} attrFlags_t;
